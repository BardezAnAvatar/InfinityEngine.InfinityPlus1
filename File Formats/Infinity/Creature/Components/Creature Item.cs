...
{
    public class CreatureItem : IInfinityFormat
    {
        ...
        protected String GetItemFlagsString()
        {
            ...
            StringFormat.AppendSubItem(sb, (this.flags & ItemInstanceFlags.MagicalUndroppable) == ItemInstanceFlags.MagicalUndroppable, ItemInstanceFlags.MagicalUndroppable.GetDescription());
