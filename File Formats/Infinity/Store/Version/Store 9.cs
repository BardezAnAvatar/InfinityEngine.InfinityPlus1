...
{
    /// <summary>Version 9.0 store, used in Icewind Dale and Icewind Dale II</summary>
    public class Store9 : IInfinityFormat
    {
        #region Members
        /// <summary>Store file header</summary>
        protected StoreHeader2 header;
