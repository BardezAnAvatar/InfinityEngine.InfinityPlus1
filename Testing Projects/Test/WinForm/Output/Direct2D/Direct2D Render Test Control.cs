...
namespace Bardez.Projects.InfinityPlus1.Test.WinForm.Output.Direct2D
{
    ...
    public partial class Direct2DRenderTestControl : UserControl
    {
        ...
        /// <summary>Default constructor</summary>
        public Direct2DRenderTestControl()
        {
            InitializeComponent();
        ...
        protected void btnInitialize_Click(Object sender, EventArgs e)
        {
            lock (this.interfaceLock)
            {
                if (this.lstboxImages.Items.Count < 1)
                {
                    ...
                    List<String> paths = ConfigurationHandlerMulti.GetSettingValues(Direct2DRenderTestControl.configKey);
