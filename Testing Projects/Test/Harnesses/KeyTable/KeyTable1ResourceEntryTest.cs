...
namespace Bardez.Projects.InfinityPlus1.Test.Harnesses.KeyTable
{
    ...
    public class KeyTable1ResourceEntryTest : FileTesterBase
    {
        #region Fields
        ...
        public KeyTable1ResourceEntryTest()
        {
        ...
        {
            this.FilePaths = ConfigurationHandlerMulti.GetSettingValues(KeyTable1ResourceEntryTest.configKey);
        }
