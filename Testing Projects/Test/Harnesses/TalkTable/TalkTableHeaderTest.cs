...
namespace Bardez.Projects.InfinityPlus1.Test.Harnesses.TextLocationKey
{
    ...
    public class TalkTableHeaderTest : FileTesterBase
    {
        #region Fields
        ...
        {
            this.FilePaths = ConfigurationHandlerMulti.GetSettingValues(TalkTableHeaderTest.configKey);
        }
