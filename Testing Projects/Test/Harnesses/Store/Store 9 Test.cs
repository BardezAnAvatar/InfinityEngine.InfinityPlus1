...
{
    /// <summary>This class tests the usable methods in the Bardez.Projects.InfinityPlus1.FileFormats.Infinity.Store.Version.Store9 class.</summary>
    public class Store9Test : FileTesterBase
    {
        #region Fields
        /// <summary>Constant key to look up in app.config</summary>
        protected const String configKey = "Test.Store.Store9Path";

        /// <summary>Format instance to test</summary>
        protected Store9 Store { get; set; }
        #endregion
        ...
        {
            this.FilePaths = ConfigurationHandlerMulti.GetSettingValues(Store9Test.configKey);
        }
