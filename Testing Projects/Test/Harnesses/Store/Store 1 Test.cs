...
{
    /// <summary>This class tests the usable methods in the Bardez.Projects.InfinityPlus1.FileFormats.Infinity.Store.Version.Store1 class.</summary>
    public class Store1Test : FileTesterBase
    {
        #region Fields
        /// <summary>Constant key to look up in app.config</summary>
        protected const String configKey = "Test.Store.Store1Path";

        /// <summary>Format instance to test</summary>
        protected Store1 Store { get; set; }
        #endregion
        ...
        {
            this.FilePaths = ConfigurationHandlerMulti.GetSettingValues(Store1Test.configKey);
        }
