...
{
    /// <summary>This class tests the usable methods in the Bardez.Projects.InfinityPlus1.FileFormats.Infinity.Creature.Creature9.Creature9 class.</summary>
    public class Creature9Test : FileTesterBase
    {
        #region Fields
        ...
        protected Creature9 Creature { get; set; }
        #endregion

        #region Construction
        /// <summary>Default constructor</summary>
        public Creature9Test()
        {
        ...
        {
            this.FilePaths = ConfigurationHandlerMulti.GetSettingValues(Creature9Test.configKey);
        }
