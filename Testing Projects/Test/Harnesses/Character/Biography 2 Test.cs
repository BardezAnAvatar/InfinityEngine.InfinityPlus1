...
namespace Bardez.Projects.InfinityPlus1.Test.Harnesses.Character
{
    ...
    public class Biography2Test : FileTesterBase
    {
        ...
        protected const String configKey = "Test.Character.Biography2Path";

        /// <summary>Format instance to test</summary>
        protected Biography2 Biography { get; set; }
        #endregion

        #region Construction
        /// <summary>Default constructor</summary>
        public Biography2Test()
        {
        ...
        {
            this.FilePaths = ConfigurationHandlerMulti.GetSettingValues(Biography2Test.configKey);
        }
