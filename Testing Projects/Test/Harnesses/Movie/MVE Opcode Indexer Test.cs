...
namespace Bardez.Projects.InfinityPlus1.Test.Harnesses.Movie
{
    ...
    public class MveOpcodeIndexerTest : FileTesterBase
    {
        #region Fields
        ...
        protected MveChunkOpcodeIndexer Mve { get; set; }
        #endregion


        #region Construction
        /// <summary>Default constructor</summary>
        public MveOpcodeIndexerTest()
        {
        ...
        {
            this.FilePaths = ConfigurationHandlerMulti.GetSettingValues(MveOpcodeIndexerTest.configKey);
        }
        ...
        protected override void TestCase(Object sender, TestEventArgs testArgs)
        {
            ...
            {
                this.Mve = new MveChunkOpcodeIndexer();
