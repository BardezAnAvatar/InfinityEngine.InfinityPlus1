...
{
    /// <summary>Test harness for a Mosaic v2 file</summary>
    public class Mosaic2Test : FileTesterBase
    {
        #region Constants
        /// <summary>Constant key to look up in app.config</summary>
        protected const String configKey = "Test.MOS2.Path";
        #endregion


        #region Fields
        /// <summary>Format instance to test</summary>
        protected Mosaic_v2 mos { get; set; }
        #endregion
        ...
        {
            this.FilePaths = ConfigurationHandlerMulti.GetSettingValues(Mosaic2Test.configKey);
        }
        ...
        protected override void TestCase(Object sender, TestEventArgs testArgs)
        {
            ...
            {
                this.mos = new Mosaic_v2();
                this.DoPostMessage(new MessageEventArgs("Reading MOS v2 file...", "Reading", testArgs.Path));
