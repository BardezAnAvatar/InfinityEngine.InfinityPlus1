...
{
    /// <summary>This class tests the usable methods in the Bardez.Projects.InfinityPlus1.FileFormats.Infinity.Item.Item2.Item2 class.</summary>
    public class Item2Test : FileTesterBase
    {
        #region Fields
        /// <summary>Constant key to look up in app.config</summary>
        protected const String configKey = "Test.Item.Item2Path";

        /// <summary>Format instance to test</summary>
        protected Item2 Item { get; set; }
        #endregion
        ...
        {
            this.FilePaths = ConfigurationHandlerMulti.GetSettingValues(Item2Test.configKey);
        }
