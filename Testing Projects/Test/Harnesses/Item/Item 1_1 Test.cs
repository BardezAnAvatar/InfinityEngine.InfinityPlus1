...
{
    /// <summary>This class tests the usable methods in the Bardez.Projects.InfinityPlus1.FileFormats.Infinity.Item.Item1_1.Item1_1 class.</summary>
    public class Item1_1Test : FileTesterBase
    {
        #region Fields
        ...
        protected Item1_1 Item { get; set; }
        #endregion
        ...
        {
            this.FilePaths = ConfigurationHandlerMulti.GetSettingValues(Item1_1Test.configKey);
        }
