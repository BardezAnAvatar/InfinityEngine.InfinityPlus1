...
namespace Bardez.Projects.InfinityPlus1.FileFormats.External.Image.Mathematics
{
    ...
    public static class DiscreteCosineTransformation
    {
        ...
        #region Double-precision Floating-point
        /// <summary>Performs the inverse DCT on the list of FDCT values</summary>
        /// <param name="fDctList">List of integer Forward DCT values</param>
        /// <returns>A List of integer values of from the inverse DCT</returns>
        /// <remarks>
            ...
            Double in0, Double in1, Double in2, Double in3, Double in4, Double in5, Double in6, Double in7)
        {
            ...
            /* phase 1, as some call it */
            o7 = reg7 * DiscreteCosineTransformation.rootHalf;
            o4 = reg4 * DiscreteCosineTransformation.rootHalf;
            DiscreteCosineTransformation.ButterflyFloat(out o7, out o4, o7, o4); //the butterfly right after is easy to miss in the Bukhari, Kuzmanov and Vassiliadis paper / PDF

            //butterfly
            DiscreteCosineTransformation.ButterflyFloat(out o0, out o1, reg0, reg1);

            //rotate 2, 6
            DiscreteCosineTransformation.RotateFloat(out o2, out o3, reg2, reg3, DiscreteCosineTransformation.rotateC6, DiscreteCosineTransformation.rotateS6);
            /* end phase 1 */


            /* 'phase' 2 */
            DiscreteCosineTransformation.ButterflyFloat(out o0, out o3, o0, o3);
            DiscreteCosineTransformation.ButterflyFloat(out o1, out o2, o1, o2);
            DiscreteCosineTransformation.ButterflyFloat(out o4, out o6, o4, reg6);
            DiscreteCosineTransformation.ButterflyFloat(out o7, out o5, o7, reg5);
            /* end 'phase' 2 */


            /* phase 3, rotation, could be part of phase 2, still, I guess */
            DiscreteCosineTransformation.RotateFloat(out o5, out o6, o5, o6, DiscreteCosineTransformation.rotateC1, DiscreteCosineTransformation.rotateS1);
            DiscreteCosineTransformation.RotateFloat(out o4, out o7, o4, o7, DiscreteCosineTransformation.rotateC3, DiscreteCosineTransformation.rotateS3);
            /* end phase 3 */


            /* phase 4, final butterfly */
            DiscreteCosineTransformation.ButterflyFloat(out o0, out o7, o0, o7);
            DiscreteCosineTransformation.ButterflyFloat(out o1, out o6, o1, o6);
            DiscreteCosineTransformation.ButterflyFloat(out o2, out o5, o2, o5);
            DiscreteCosineTransformation.ButterflyFloat(out o3, out o4, o3, o4);
            /* end phase 4*/
        }
