...
namespace Bardez.Projects.InfinityPlus1.FileFormats.External.Image.JPEG
{
    ...
    public class ComponentDataInteger : ComponentData<Int32>
    {
        ...
        public ComponentDataInteger()
        {
            this.SourceData = new List<Int32>();
            this.SampleData = new List<Int32>();
        }
        #endregion
        ...
        {
            this.SampleData = DiscreteCosineTransformation.InverseDiscreteCosineTransformFastInteger(this.SampleData);
        }
