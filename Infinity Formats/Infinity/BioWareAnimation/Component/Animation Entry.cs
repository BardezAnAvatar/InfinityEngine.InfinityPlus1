...
{
    /// <summary>Represents an entry of a single animation set of frames, like a disjoint header</summary>
    public class AnimationEntry : IInfinityFormat
    {
        #region Constants
        ...
        #region Fields
        /// <summary>Count of frames in this animation</summary>
        public UInt16 FrameCount { get; set; }

        /// <summary>Index in the lookup table of the first frame</summary>
        public UInt16 StartFrame { get; set; }
        #endregion
        ...
        public void ReadBody(Stream input)
        {
            ...
            Byte[] data = ReusableIO.BinaryRead(input, AnimationEntry.StructSize);

            this.FrameCount = ReusableIO.ReadUInt16FromArray(data, 0);
            this.StartFrame = ReusableIO.ReadUInt16FromArray(data, 2);
        }
        ...
        {
            ReusableIO.WriteUInt16ToStream(this.FrameCount, output);
            ReusableIO.WriteUInt16ToStream(this.StartFrame, output);
        }
        #endregion
        ...
        {
            return String.Format("Animation Entry # {0,5}:", index);
        }
        ...
        protected String GetStringRepresentation()
        {
            ...
            builder.Append(StringFormat.ToStringAlignment("Start Frame Index"));
        ...
        public override Boolean Equals(Object obj)
        {
            ...
            try
            {
                if (obj != null && obj is AnimationEntry)
                {
