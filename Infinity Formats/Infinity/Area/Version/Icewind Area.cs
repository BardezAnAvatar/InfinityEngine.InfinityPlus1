...
{
    /// <summary>Represents an area for IWD</summary>
    public class IcewindArea : AreaBase
    {
        #region Fields
        ...
        public Dictionary<Int32, Creature9> Creatures { get; set; }
        #endregion
        ...
        public override void Initialize()
        {
            ...
            this.Creatures = new Dictionary<Int32, Creature9>();
        }
        #endregion
        ...
        protected override void ReadEmbeddedCreatures(Stream input)
        {
            foreach (Actor actor in this.Actors)
            {
                if (actor.OffsetCreStruct > 0)
                {
                    ...
                    {
                        Creature9 creature = new Creature9();
        ...
        protected override void WriteEmbeddedCreatures(Stream output)
        {
            foreach (Int32 key in this.Creatures.Keys)
            {
                ...
                this.Creatures[key].Write(output);
            }
        }
        #endregion
        #endregion
        ...
        protected override void ResetOffsets()
        {
            ...
            foreach (Actor actor in this.Actors)
                if (actor.OffsetCreStruct > 0)
                {
                    Creature9 cre = this.Creatures[actor.OffsetCreStruct];
