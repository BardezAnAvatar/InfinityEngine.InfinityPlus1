...
{
    /// <summary>Represents an area v. 9.1 for IWD2</summary>
    public class Icewind2Area : AreaBase
    {
        #region Fields
        /// <summary>Header for this area</summary>
        public Icewind2AreaHeader Header { get; set; }

        /// <summary>Collection of spawn points in this area</summary>
        public List<Icewind2SpawnPoint> SpawnPoints { get; set; }
        ...
        public Dictionary<Int32, Creature2_2> Creatures { get; set; }
        #endregion
        ...
        public override void Initialize()
        {
            ...
            this.Header = new Icewind2AreaHeader();
            this.SpawnPoints = new List<Icewind2SpawnPoint>();
            this.MapNotes = new List<CommonMapNote>();
            this.Creatures = new Dictionary<Int32, Creature2_2>();
        }
        #endregion
        ...
        protected override void ReadSpawnPoints(Stream input, Int32 offset, Int32 count)
        {
            if (offset > 0)
            {
                ...
                {
                    Icewind2SpawnPoint spawnPoint = new Icewind2SpawnPoint();
        ...
        protected override void ReadEmbeddedCreatures(Stream input)
        {
            foreach (Actor actor in this.Actors)
            {
                if (actor.OffsetCreStruct > 0)
                {
                    ...
                    {
                        Creature2_2 creature = new Creature2_2();
        ...
        protected override void WriteSpawnPoints(Stream output, Int32 offset)
        {
            if (offset > 0)
            {
                ...
                foreach (Icewind2SpawnPoint spawnPoint in this.SpawnPoints)
        ...
        protected override List<Tuple<Int64, Int64>> CollectOffsets()
        {
            ...
            //header
            offsetCollection.Add(new Tuple<Int64, Int64>(0L, Icewind2AreaHeader.StructSize));
            ...
            //spawn points
            offsetCollection.Add(new Tuple<Int64, Int64>(this.Header.OffsetSpawnPoints, this.Header.CountSpawnPoints * Icewind2SpawnPoint.StructSize));
        ...
        protected override void ResetOffsets()
        {
            ...
            //skip header
            offset += Icewind2AreaHeader.StructSize;
            ...
            offset += (this.Header.CountSpawnPoints * Icewind2SpawnPoint.StructSize);
            ...
            foreach (Actor actor in this.Actors)
                if (actor.OffsetCreStruct > 0)
                {
                    Creature2_2 cre = this.Creatures[actor.OffsetCreStruct];
