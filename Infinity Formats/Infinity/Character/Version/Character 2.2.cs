...
{
    /// <summary>Character 2.2, used in Icewind Dale II</summary>
    public class Character2_2 : IInfinityFormat
    {
        #region Members
        /// <summary>Character file header</summary>
        protected Character2_2Header header;
        ...
        #region Properties
        /// <summary>Character file header</summary>
        public Character2_2Header Header
        {
        ...
        {
            this.header = new Character2_2Header();
        ...
        public void Write(Stream output)
        {
            ...
            if (buffer.Length != this.header.LengthCreature || this.header.OffsetCreature < Character2_2Header.StructSize)
            {
                this.header.OffsetCreature = Convert.ToUInt32(Creature2_2Header.StructSize);
