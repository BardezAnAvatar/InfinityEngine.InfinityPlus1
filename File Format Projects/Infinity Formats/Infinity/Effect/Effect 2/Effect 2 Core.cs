...
namespace Bardez.Projects.InfinityPlus1.FileFormats.Infinity.Effect.Effect2
{
    ...
    public class Effect2Core : EffectBase
    {
        ...
        public override void ReadBody(Stream input)
        {
            ...
            this.resource2.ResRef = ReusableIO.ReadStringFromByteArray(remainingBody, 88, CultureConstants.CultureCodeEnglish);
            this.resource3.ResRef = ReusableIO.ReadStringFromByteArray(remainingBody, 96, CultureConstants.CultureCodeEnglish);
            this.resourceUnknown.ResRef = ReusableIO.ReadStringFromByteArray(remainingBody, 104, CultureConstants.CultureCodeEnglish);
            ...
            this.parentResource.ResRef = ReusableIO.ReadStringFromByteArray(remainingBody, 132, CultureConstants.CultureCodeEnglish);
            ...
            this.LocalVariableName.Source = ReusableIO.ReadStringFromByteArray(remainingBody, 152, CultureConstants.CultureCodeEnglish, 32);
        ...
        public override void Write(Stream output)
        {
            ...
            ReusableIO.WriteStringToStream(this.resource2.ResRef, output, CultureConstants.CultureCodeEnglish);
            ReusableIO.WriteStringToStream(this.resource3.ResRef, output, CultureConstants.CultureCodeEnglish);
            ReusableIO.WriteStringToStream(this.resourceUnknown.ResRef, output, CultureConstants.CultureCodeEnglish);
            ...
            ReusableIO.WriteStringToStream(this.parentResource.ResRef, output, CultureConstants.CultureCodeEnglish);
            ...
            ReusableIO.WriteStringToStream(this.LocalVariableName.Source, output, CultureConstants.CultureCodeEnglish, false, 32);
