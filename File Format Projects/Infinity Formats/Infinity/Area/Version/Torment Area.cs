...
{
    /// <summary>Area version 1.0 for PS:T</summary>
    public class TormentArea : AreaBase
    {
        #region Fields
        /// <summary>Header for this area</summary>
        public TormentAreaHeader Header { get; set; }
        ...
        public List<TormentMapNote> MapNotes { get; set; }

        /// <summary>Represents the collection of creatures, keyed with the offset as the unique key</summary>
        public Dictionary<Int32, Creature1_2> Creatures { get; set; }
        #endregion
        ...
        public override void Initialize()
        {
            ...
            this.Header = new TormentAreaHeader();
            this.SpawnPoints = new List<CommonSpawnPoint>();
            this.MapNotes = new List<TormentMapNote>();
            this.Creatures = new Dictionary<Int32, Creature1_2>();
        }
        #endregion
        ...
        protected override void ReadMapNotes(Stream input, Int32 offset, Int32 count)
        {
            if (offset > 0)
            {
                ...
                for (Int32 counter = 0; counter < count; ++counter)
                {
                    TormentMapNote mapNote = new TormentMapNote();
                    mapNote.Read(input);
        ...
        protected override void ReadEmbeddedCreatures(Stream input)
        {
            foreach (Actor actor in this.Actors)
            {
                if (actor.OffsetCreStruct > 0)
                {
                    ...
                    {
                        Creature1_2 creature = new Creature1_2();
        ...
        protected override void WriteMapNotes(Stream output, Int32 offset)
        {
            if (offset > 0)
            {
                ...
                foreach (TormentMapNote mapNote in this.MapNotes)
        ...
        protected override List<Tuple<Int64, Int64>> CollectOffsets()
        {
            ...
            //header
            offsetCollection.Add(new Tuple<Int64, Int64>(0L, TormentAreaHeader.StructSize));
        ...
        protected override void ResetOffsets()
        {
            ...
            //skip header
            offset += TormentAreaHeader.StructSize;
            ...
            offset += (this.Header.CountMapNote * TormentMapNote.StructSize);
            ...
            foreach (Actor actor in this.Actors)
                if (actor.OffsetCreStruct > 0)
                {
                    Creature1_2 cre = this.Creatures[actor.OffsetCreStruct];
        ...
        {
            return "Planescape: Torment area";
        }
