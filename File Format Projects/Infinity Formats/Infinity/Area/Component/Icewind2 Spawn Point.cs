...
{
    /// <summary>Spawn point for IWD2</summary>
    public class Icewind2SpawnPoint : SpawnPointBase
    {
        #region Fields
        /// <summary>Spawn flags</summary>
        public Icewind2SpawnFlags Flags { get; set; }
        #endregion
        ...
        public override void ReadSpawnMethod(Stream input)
        {
            ...
            this.Flags = (Icewind2SpawnFlags)ReusableIO.ReadUInt16FromArray(buffer, 0);
        }
        ...
        protected String GetSpawnFlagsEnumerationString()
        {
            ...
            StringFormat.AppendSubItem(builder, (this.Flags & Icewind2SpawnFlags.OnRest) == Icewind2SpawnFlags.OnRest, Icewind2SpawnFlags.OnRest.GetDescription());
            StringFormat.AppendSubItem(builder, (this.Flags & Icewind2SpawnFlags.OnRevealed) == Icewind2SpawnFlags.OnRevealed, Icewind2SpawnFlags.OnRevealed.GetDescription());
