...
namespace Bardez.Projects.InfinityPlus1.FileFormats.Infinity.Script.IWD2
{
    ...
    ///     IWD2:   [Int] x 13, [Point-tangle] x 1, [String] x 1, [Int] x 2
    /// </remarks>
    public class Icewind2ObjectBlock : ObjectBlock
    {
        //#region Properties
        ...
        ///// <summary>Exposes the first unknown trailing parameter</summary>
        //public Int64 UnknownParameter1
        //{
        //    get { return this.parameters[0]; }
        //    set { this.parameters[0] = value; }
        //}

        ///// <summary>Exposes the second unknown trailing parameter</summary>
        //public Int64 UnknownParameter2
        //{
        //    get { return this.parameters[1]; }
        //    set { this.parameters[1] = value; }
        //}
        //#endregion
    }
}