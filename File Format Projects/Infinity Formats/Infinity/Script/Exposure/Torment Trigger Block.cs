...
{
    /// <summary>A PS:T BioWare script's trigger block container</summary>
    /// <remarks>
    ...
    /// </remarks>
    public class TormentTriggerBlock : TriggerBlock
    {
        #region Fields
        /// <summary>Point parameter</summary>
        ...
        {
            //this.objBlock = new TormentObjectBlock();
        }
        #endregion
    }
}