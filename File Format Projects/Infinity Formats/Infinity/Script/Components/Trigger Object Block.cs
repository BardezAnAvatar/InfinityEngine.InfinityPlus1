...
namespace Bardez.Projects.InfinityPlus1.FileFormats.Infinity.Script.Components
{
    ...
    public class TriggerObjectBlock : ObjectBlock
    {
        #region IO methods
        ...
        public virtual void Read(PeekSeekTextReader input)
        {
            try
            {
                ...
                this.preceedingOpenToken = ScriptReader.ReadUntilToken(input, new ReadableToken(Delimiters.ObjectDelimiter, true));
                ...
                this.preceedingCloseToken = ScriptReader.ReadUntilToken(input, new ReadableToken(Delimiters.ObjectDelimiter, true));
