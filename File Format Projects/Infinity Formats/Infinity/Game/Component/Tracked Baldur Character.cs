...
{
    /// <summary>Represents the character structure within the GAM stream, BG1 + BG2</summary>
    public class TrackedBaldurCharacter : TrackedPlayableCharacterBase
    {
        #region Constants
        /// <summary>Size of the structure on disk</summary>
        public const Int32 StructSize = 352;
        #endregion
