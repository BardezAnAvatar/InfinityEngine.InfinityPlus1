...
{
    /// <summary>This class tests the usable methods in the Bardez.Projects.InfinityPlus1.FileFormats.Infinity.Creature.Creature1.Creature1_2Header class.</summary>
    public class CreatureHeader1_2Test : FileTesterBase
    {
        #region Fields
        /// <summary>Constant key to look up in app.config</summary>
        protected const String configKey = "Test.Creature.Creature1.2Path";

        /// <summary>Format instance to test</summary>
        protected Creature1_2Header Header { get; set; }
        #endregion

        #region Construction
        /// <summary>Default constructor</summary>
        public CreatureHeader1_2Test()
        {
        ...
        {
            this.FilePaths = ConfigurationHandlerMulti.GetSettingValues(CreatureHeader1_2Test.configKey);
        }
