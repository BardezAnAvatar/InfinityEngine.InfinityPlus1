...
{
    /// <summary>This class tests the usable methods in the Bardez.Projects.InfinityPlus1.FileFormats.Infinity.Creature.Creature1.Creature1 class.</summary>
    public class Creature1Test : FileTesterBase
    {
        #region Fields
        /// <summary>Constant key to look up in app.config</summary>
        protected const String configKey = "Test.Creature.Creature1Path";

        /// <summary>Format instance to test</summary>
        protected Creature1 Creature { get; set; }
        #endregion

        #region Construction
        /// <summary>Default constructor</summary>
        public Creature1Test()
        {
        ...
        {
            this.FilePaths = ConfigurationHandlerMulti.GetSettingValues(Creature1Test.configKey);
        }
