...
{
    /// <summary>This class tests the usable methods in the Bardez.Projects.InfinityPlus1.FileFormats.Infinity.Creature.Creature1.Creature1_2 class.</summary>
    public class Creature1_2Test : FileTesterBase
    {
        #region Fields
        ...
        protected Creature1_2 Creature { get; set; }
        #endregion

        #region Construction
        /// <summary>Default constructor</summary>
        public Creature1_2Test()
        {
        ...
        {
            this.FilePaths = ConfigurationHandlerMulti.GetSettingValues(Creature1_2Test.configKey);
        }
