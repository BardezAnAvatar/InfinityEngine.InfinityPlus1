...
namespace Bardez.Projects.InfinityPlus1.Test.Harnesses.Creature
{
    ...
    public class CreatureHeader1Test : FileTesterBase
    {
        ...
        protected Creature1Header Header { get; set; }
        #endregion

        #region Construction
        /// <summary>Default constructor</summary>
        public CreatureHeader1Test()
        {
        ...
        {
            this.FilePaths = ConfigurationHandlerMulti.GetSettingValues(CreatureHeader1Test.configKey);
        }
