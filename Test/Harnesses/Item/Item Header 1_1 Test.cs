...
{
    /// <summary>This class tests the usable methods in the Bardez.Projects.InfinityPlus1.FileFormats.Infinity.Item.Item1_1.ItemHeader1_1 class.</summary>
    public class ItemHeader1_1Test : FileTesterBase
    {
        #region Fields
        ...
        protected ItemHeader1_1 Header { get; set; }
        #endregion

        #region Construction
        /// <summary>Default constructor</summary>
        public ItemHeader1_1Test()
        {
        ...
        {
            this.FilePaths = ConfigurationHandlerMulti.GetSettingValues(ItemHeader1_1Test.configKey);
        }
