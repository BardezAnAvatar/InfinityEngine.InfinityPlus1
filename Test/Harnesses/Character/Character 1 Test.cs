...
namespace Bardez.Projects.InfinityPlus1.Test.Harnesses.Character
{
    ...
    public class Character1Test : FileTesterBase
    {
        ...
        protected const String configKey = "Test.Character.Character1Path";

        /// <summary>Format instance to test</summary>
        protected Character1 Character { get; set; }
        #endregion

        #region Construction
        /// <summary>Default constructor</summary>
        public Character1Test()
        {
        ...
        {
            this.FilePaths = ConfigurationHandlerMulti.GetSettingValues(Character1Test.configKey);
        }
